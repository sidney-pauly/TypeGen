...
namespace TypeGen.Core.Utils
{
    ...
    /// </summary>
    public static partial class GuidUtility
    {
        /// <summary>
        ...
        public static Guid Create(this Guid namespaceId, string name) => Create(namespaceId, name, 5);
        ...
        /// <returns>A UUID derived from the namespace and name.</returns>
        public static Guid Create(this Guid namespaceId, byte[] nameBytes) => Create(namespaceId, nameBytes, 5);

        /// <summary>
        /// Creates a name-based UUID using the algorithm from RFC 4122 §4.3.
        /// </summary>
        /// <param name="namespaceId">The ID of the namespace.</param>
        /// <param name="toNamespace">The name (within that namespace).</param>
        /// <returns>A UUID derived from the namespace and name.</returns>
        public static Guid Create(this Guid namespaceId, Guid toNamespace) => Create(namespaceId, toNamespace.ToByteArray());
        ...
        /// 3 (for MD5 hashing) or 5 (for SHA-1 hashing).</param>
        /// <returns>A UUID derived from the namespace and name.</returns>
        public static Guid Create(this Guid namespaceId, byte[] nameBytes, int version)
        {
